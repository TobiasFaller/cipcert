smoketest:
	...
	@printf "Reset      (E(s) A(s'\\\\s) -(i ^ u => i' ^ u'))             "; ./build/bin/quabs "examples/1_reset.cir"; true
	@printf "Transition (E(s) A(s'\\\\s) -(t ^ u0 ^ u1 ^ u' => t' ^ u1')) "; ./build/bin/quabs "examples/2_transition.cir"; true
	@printf "Property   (E(s) A(s'\\\\s) -(u ^ u' => (-g => -g')))        "; ./build/bin/quabs "examples/3_property.cir"; true
	@printf "Base       (E(s') -(i' ^ u' => -g'))                      "; ./build/bin/quabs "examples/4_base.cir"; true
	@printf "Step       (E(s') -(-g0' ^ t' ^ u0' ^ u1' => -g1'))       "; ./build/bin/quabs "examples/5_step.cir"; true
